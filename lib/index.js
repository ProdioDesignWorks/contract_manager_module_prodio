...
var funListContractsForUser = function funListContractsForUser(BASE_URL, payload, callback) {
  if (isNull(payload["meta"]["businessId"])) {
    return callback(new HttpErrors.BadRequest('businessId is mandatory.', { expose: false }));
  }
  ...
  var url = BASE_URL + 'Contracts/listContractsForUser';
  axios.post(url, payload).then(function (response) {
    //console.log(response)
    return callback(response);
  }).catch(function (error) {
...
var funCheckIfTemplateHasSigningFields = function funCheckIfTemplateHasSigningFields(BASE_URL, payload, callback) {
  if (isNull(payload["meta"]["businessId"])) {
    return callback(new HttpErrors.BadRequest('businessId is mandatory.', { expose: false }));
  }
  ...
  var url = BASE_URL + 'Templates/checkSigningFields';
  axios.post(url, payload).then(function (response) {
    //console.log(response)
    return callback(response);
  }).catch(function (error) {
